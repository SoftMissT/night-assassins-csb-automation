        ...
        const result = validateKekkijutsuUse(
            {
                system: {
                    props: {
                        ...
                        kekki_uso_kekki_coro_perdidos_turno: true,
                    },
                },
            },
            tech
        ...
        const result = validateKekkijutsuUse(
            {
                system: {
                    props: {
                        nvl_num: 9,
                        pdk_oni_atual_num: 20,
                        kekki_uso_kekki_sonolencia_eterna_cena: true,
                    },
                },
            },
            tech
...
describe('kekkijutsu estado e resets', () => {
    ...
    it('resetKekkijutsuSceneState limpa usos de cena/combate', () => {
        const patch = resetKekkijutsuSceneState({
            kekki_uso_kekki_test_cena: true,
            kekki_uso_kekki_test_combate: true,
        });
