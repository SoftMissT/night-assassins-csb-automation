...
function slayerProps(overrides = {}) {
  return {
    ...
    atr_vit_valor: 4, vit_display: 6,
    atr_dex_valor: 3, dex_display: 5,
    atr_for_valor: 3, for_display: 5,
    atr_car_valor: 2, car_display: 4,
    atr_fdv_valor: 3, fdv_display: 5,
    atr_int_valor: 2, int_display: 4,
    atr_sab_valor: 2, sab_display: 4,
    ...overrides,
  };
}
...
function oniProps(overrides = {}) {
  return {
    ...
    atr_vit_valor: 5, vit_display: 7,
    atr_dex_valor: 3, dex_display: 5,
    atr_for_valor: 4, for_display: 6,
    atr_car_valor: 1, car_display: 3,
    atr_fdv_valor: 3, fdv_display: 5,
    atr_int_valor: 2, int_display: 4,
    atr_sab_valor: 2, sab_display: 4,
    ...overrides,
...
export function makeOniActor(overrides = {}) {
  return { id: "oni-test-01", name: "Yokai Onryo", system: { template: "oni_template", props: oniProps(overrides) } };
}

export function makeOniMinionActor(overrides = {}) {
  return { id: "minion-test-01", name: "Lacaio Rapido", system: { template: "oni_minion_template", props: oniMinionProps(overrides) } };
}

export function makeNpcActor(overrides = {}) {
  return { id: "npc-test-01", name: "Taverneiro", system: { template: "npc_template", props: npcProps(overrides) } };
}

export const SEVEN_ATTRIBUTES = SEVEN_ATTRS;

export const EXPECTED = {
  slayer: { kind: "slayer", resourcePrimary: "pdv_slayer_total_valor", resourceSecondary: "pdr_slayer_total_valor", namespace: "slayer" },
  oni: { kind: "oni", resourcePrimary: "pdv_oni_total_valor", resourceSecondary: "pdk_oni_total_valor", namespace: "oni" },
  oni_minion: { kind: "oni_minion", resourcePrimary: "oni_minion_pdv_base", resourceSecondary: "oni_minion_pdk_base", namespace: "oni_minion" },
};
