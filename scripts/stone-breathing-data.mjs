...
export const STONE_FORMS = Object.freeze([
    {
        ...
        levels: [
            LEVEL(1, {
                damage: '1d4',
                damageTypes: ['ferida'],
                damageComponents: [{ formula: '1d4', types: ['ferida'] }],
            }),
            LEVEL(2, {
                damage: '1d6',
                damageTypes: ['ferida'],
                damageComponents: [{ formula: '1d6', types: ['ferida'] }],
            }),
            LEVEL(2, {
                damage: '2d4',
                damageTypes: ['ferida'],
                damageComponents: [{ formula: '2d4', types: ['ferida'] }],
            }),
            LEVEL(3, {
                damage: '2d4 + @for',
                damageTypes: ['ferida', 'concussao'],
                damageComponents: [
    ...
    },
    {
        id: 'pedra_02',
        style: 2,
        name: 'Tenmen Kudaki / Hyōmen Kurasshu / Kyoseki',
    ...
    },
    {
        id: 'pedra_03',
        style: 3,
        name: "Ganku no Hadae / Sutōn'arō",
        ptName: 'Reflexão Ígnea / Flechas de Pedra',
        action: 'reacao',
        levels: [
            LEVEL(3, { attackPenaltyBase: 1 }),
            LEVEL(3, { attackPenaltyBase: 2 }),
    ...
    },
    {
        id: 'pedra_04',
        style: 4,
        name: 'Ryūmongan, Sokusei / Keikoku',
        ptName: 'Riólito, Subjugação Rápida / Ravina',
        actions: ['ataque', 'especial'],
        levels: [
            null,
            null,
            LEVEL(6, {
