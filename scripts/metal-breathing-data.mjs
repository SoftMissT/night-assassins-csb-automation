...
export const METAL_FORMS = Object.freeze([
  { id: "metal_01", style: 1, name: "Metalizado", action: "unica", levels: [
  ...
  { id: "metal_02", style: 2, name: "Inabalável", action: "especial", levels: [
    LEVEL(2, { turns: 2 }), LEVEL(2, { turns: 2 }), LEVEL(2, { turns: 2 }), LEVEL(2, { turns: 2 }),
  ] },
  { id: "metal_03", style: 3, name: "Reação em Cadeia", action: "especial", levels: [
    LEVEL(2, { damageBonus: 2 }), LEVEL(3, { damageBonus: 4 }),
    LEVEL(3, { damageBonus: 6 }), LEVEL(4, { damageBonus: 8 }),
  ] },
  { id: "metal_04", style: 4, name: "Duro como Aço", action: "completa", levels: [
    null,
    LEVEL(2, { defenseAdvantage: true }),
    LEVEL(4, { negateAttack: true }),
    LEVEL(5, { negateAttack: true, counterAttack: true }),
  ] },
  { id: "metal_06", style: 5, name: "Forjado na Batalha", action: "ataque", levels: [
