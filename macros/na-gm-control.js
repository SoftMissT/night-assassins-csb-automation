(async () => {
    ...
    if (!game.user?.isGM)
        return ui.notifications.error('Somente o GM pode abrir o Controle dos Caçadores.');
    ...
    if (typeof args !== 'undefined' && args?.debug === true)
        console.log(`[TANG-ROU] Controle GM aberto em ${(performance.now() - t0).toFixed(2)}ms`);
})();
