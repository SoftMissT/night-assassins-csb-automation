...
describe('derived-bonus-service', () => {
    ...
    it('anexa contribuição temporária sem persistir total', () => {
        const result = resolveSlayerDerivedBonuses(
            { hab_acerto_bonus: 1 },
            {
                runtimeSources: [
                    { channel: 'acerto', value: 2, label: 'Forma', origin: 'Respiração' },
                ],
            }
        );
