...
import { makeSlayerActor, makeOniActor, makeOniMinionActor, makeNpcActor } from "./fixtures/actors.mjs";
...
describe("gm-panel-data - buildGmPanelData", () => {
  ...
  it("funciona com multiplos Slayers e Onis", () => {
    const actors = [makeSlayerActor(), makeSlayerActor({ nome_slayer: "Outro" }), makeOniActor(), makeOniMinionActor()];
    const panel = buildGmPanelData(actors);
