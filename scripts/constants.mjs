...
export const TIPOS_ACAO = Object.freeze([
    {
        ...
        scope: 'turn',
        damage: false,
        desc: '1 por turno. Movimento máximo: 7m + DEX.',
    },
    {
        key: 'ataque',
        label: 'Ação de Ataque',
        scope: 'turn',
        damage: true,
        desc: '1 por turno. Ataque Padrão ou técnicas de ataque.',
    },
    {
        key: 'especial',
        label: 'Ação Especial',
        scope: 'turn',
        damage: true,
        desc: '1 por turno. Técnicas de Ação Especial.',
    },
    {
        key: 'unica',
        label: 'Ação Única',
        scope: 'round',
        damage: true,
        desc: '1 por rodada. Nenhum efeito pode dar mais de uma.',
    },
    {
        key: 'completa',
        label: 'Ação Completa',
    ...
    },
    {
        ...
        scope: 'round',
        damage: true,
        desc: '1 por rodada. Reage a ataques como alvo.',
    },
    {
        key: 'defesa',
        label: 'Defesa',
        scope: 'free',
        damage: false,
        desc: 'Ilimitada quando o personagem é alvo.',
    },
    {
        key: 'livre',
        label: 'Ação Livre',
        scope: 'free',
        damage: false,
        desc: 'Limitada pelo Mestre. Sem efeito mecânico.',
    },
    {
        key: 'epica',
        label: 'Ação Épica',
        scope: 'special',
        damage: true,
        desc: 'Tudo ou Nada. Exige autorização e resolução própria do Mestre.',
    },
    {
        key: 'lendaria',
        label: 'Ação Lendária',
        scope: 'gm-round',
        damage: true,
        desc: '1 por rodada. Exclusiva de chefes Oni e controlada pelo Mestre.',
    },
    {
        key: 'covil',
        label: 'Ação de Covil',
        scope: 'gm-round',
        damage: true,
        desc: 'Evento ambiental na contagem 20 da iniciativa.',
    },
    {
        key: 'vilao',
        label: 'Ação de Vilão',
        scope: 'gm-phase',
        damage: false,
        desc: 'Evento de mudança de fase do chefe; limpa status negativos e libera capacidades.',
    },
]);
...
export const TIPOS_DANO = Object.freeze([
    {
        ...
        label: 'Cortante',
        cat: 'comum',
        desc: 'Reduzível e bloqueável. Dano por lâminas.',
    },
    {
        key: 'perfurante',
        label: 'Perfurante',
        cat: 'comum',
        desc: 'Reduzível e bloqueável. Dano por pontas e projéteis.',
    },
    {
        key: 'concussao',
        label: 'Concussão',
        cat: 'comum',
        desc: 'Reduzível e bloqueável. Dano por impacto e força bruta.',
    },
    {
        key: 'trovejante',
        label: 'Trovejante',
        cat: 'especial',
        desc: 'Irredutível. Pode ser anulado, nunca reduzido.',
    },
    {
        key: 'sonoro',
        label: 'Sonoro',
        cat: 'especial',
        desc: 'Inevitável. Não esquivado/bloqueado. Teste VIT (CD=10+DEX+FDV) para metade.',
    },
    {
        key: 'ferida',
        label: 'Ferida',
        cat: 'especial',
        desc: 'Reduz o PDV MÁXIMO permanentemente. Não regenera.',
    },
    {
        key: 'sangramento',
        label: 'Sangramento',
        cat: 'especial',
        desc: 'Dano por turno no início do turno do alvo.',
    },
    {
        key: 'envenenamento',
        label: 'Envenenamento',
    ...
    },
    {
        ...
        label: 'Necrótico',
        cat: 'especial',
        desc: 'Incurável em combate. Só trata com descanso longo (mín. 24h).',
    },
    {
        key: 'acido',
        label: 'Ácido',
        cat: 'elemental',
        desc: 'Ignora Bloqueio e pode aplicar Corroído.',
    },
    {
        key: 'colapso',
        label: 'Colapso',
        cat: 'elemental',
        desc: 'Pode desconectar o controle motor do alvo.',
    },
    { key: 'congelante', label: 'Congelante', cat: 'elemental', desc: 'Pode aplicar Hipotermia.' },
    {
        ...
        label: 'Elétrico',
        cat: 'elemental',
        desc: 'Pode impedir Reações até o próximo turno.',
    },
    { key: 'fogo', label: 'Fogo', cat: 'elemental', desc: 'Pode aplicar Em Chamas.' },
    {
        ...
        label: 'Impacto',
        cat: 'elemental',
        desc: 'Ignora RD de escudo/barreira e pode atordoar ou derrubar.',
    },
    {
        key: 'mental',
        label: 'Mental',
        cat: 'elemental',
        desc: 'Pode aplicar Atordoamento ou Confuso.',
    },
...
export const STATUS_SLAYER = Object.freeze([
    ...
    { key: 'surdez_parcial', label: 'Surdez Parcial', category: 'Sensorial' },
    {
        key: 'corrupcao',
        label: 'Corrupção',
        category: 'Espiritual e sobrenatural',
        stackable: true,
    },
    {
        key: 'regeneracao_suprimida',
        label: 'Regeneração Suprimida',
        category: 'Espiritual e sobrenatural',
    },
...
export function tempKey(kind, attrKey) {
    return kind === 'oni'
        ? `bonus_atr_${attrKey}_oni_valor_temp`
        : `bonus_atr_${attrKey}_valor_temp`;
}
