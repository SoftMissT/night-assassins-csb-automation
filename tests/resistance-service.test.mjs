...
import {
    formatResistanceSummary,
    normalizeResistanceKeys,
    saveActorResistances,
} from '../scripts/resistance-service.mjs';

describe('resistance-service', () => {
    it('normaliza, remove duplicatas e ignora tipos desconhecidos', () => {
        assert.deepEqual(normalizeResistanceKeys('fogo,cortante,FOGO,inexistente'), [
            'fogo',
            'cortante',
        ]);
    });
