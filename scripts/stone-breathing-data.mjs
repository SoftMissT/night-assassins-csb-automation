...
export const STONE_FORMS = Object.freeze([
  { id: "pedra_01", style: 1, name: "Jamongan Sōkyoku", ptName: "Serpentino Duplo", action: "unica", levels: [
  ...
  { id: "pedra_02", style: 2, name: "Tenmen Kudaki / Hyōmen Kurasshu / Kyoseki", ptName: "Quebra Superior / Esmagamento da Superfície / Pedregulho Gigante", action: "ataque", levels: [
  ...
  { id: "pedra_03", style: 3, name: "Ganku no Hadae / Sutōn'arō", ptName: "Reflexão Ígnea / Flechas de Pedra", action: "reacao", levels: [
  ...
  { id: "pedra_04", style: 4, name: "Ryūmongan, Sokusei / Keikoku", ptName: "Riólito, Subjugação Rápida / Ravina", actions: ["ataque", "especial"], levels: [
    null, null,
  ...
  { id: "pedra_05", style: 5, name: "Kaifuku-ryoku", ptName: "Resiliência", action: "ataque", oncePerCombat: true, levels: [
