...
export const WIND_FORMS = Object.freeze([
  {
    id: "vento_01", style: "passiva", name: "Sangue Especial (Tokubetsuna Chi)", action: "passiva",
    passive: true,
    levels: [LEVEL(0, {}), LEVEL(0, {}), LEVEL(0, {}), LEVEL(0, {})],
  },
  {
    id: "vento_02", style: 1, name: "Redemoinho de Poeira", action: "ataque",
  ...
  {
    id: "vento_02_ciclone", style: 1, name: "Ciclone Penetrante", action: "ataque",
  ...
  {
    id: "vento_03", style: 2, name: "Garras do Vento Puro", action: "unica",
    levels: [
      null,
  ...
  {
    id: "vento_04", style: 3, name: "Árvore Balançando ao Vapor da Montanha", actions: ["ataque", "reacao"],
    levels: [
  ...
  {
    id: "vento_05", style: 4, name: "Tempestade Crescente de Poeira", action: "unica",
    levels: [
  ...
  {
    id: "vento_06", style: 5, name: "Vendaval de Inverno", actions: ["unica", "ataque"],
    levels: [
  ...
  {
    id: "vento_07", style: 6, name: "Tempestade da Fumaça Escurecedora", action: "ataque",
    levels: [
      null,
  ...
  {
    id: "vento_08", style: 7, name: "Ventania Rajadas Repentinas", action: "especial",
    levels: [
  ...
  {
    id: "vento_09", style: 8, name: "Corte da Primeira Ventania", action: "completa",
    levels: [
      null, null,
  ...
  {
    id: "vento_10", style: 9, name: "Tufão Idaten", action: "completa",
    minDex: 4,
    levels: [
      null, null, null,
      LEVEL(8, {
