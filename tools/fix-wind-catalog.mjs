...
const CORRECOES = {
  ...
  vento_02: { manobra: "Ataque", req: 1, custos: ["variável", "variável", "variável", "variável"] },
...
for (const document of catalog.documents) {
  ...
  if (props.tipo_manobra !== correction.manobra) { props.tipo_manobra = correction.manobra; fixed += 1; }
  if (Number(props.nivel_req) !== correction.req) { props.nivel_req = correction.req; fixed += 1; }
