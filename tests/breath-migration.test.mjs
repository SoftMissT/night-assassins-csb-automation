...
import {
    breathingItemPatch,
    buildCanonicalBreathMap,
    repairBreathingItems,
} from '../scripts/breath-migration.mjs';
...
describe('breath-migration', () => {
    ...
    it('corrige categoria de forma sem correspondência canônica', () => {
        const homebrew = {
            ...
            system: {
                template: 'NABreathTpl00001',
                props: { forma_id: 'hb_01', nome_forma: 'Forma Criativa' },
            },
        };
    ...
    it('ignora itens não relacionados a respiração', () => {
        assert.equal(
            breathingItemPatch(
                { id: 'x', name: 'Erva', system: { props: { inventario_categoria: 'item' } } },
                null
            ),
            null
        );
    ...
    it('contabiliza Actors corrigidos e itens atualizados', async () => {
                ...
                items: [
                    {
                        ...
                        system: {
                            template: 'NABreathTpl00001',
                            props: { nome_forma: 'Céu em Chamas Ascendentes' },
                        },
                    },
        ...
        globalThis.game = {
            packs: { get: () => ({ getDocuments: () => Promise.resolve([canonicalForm]) }) },
        };
