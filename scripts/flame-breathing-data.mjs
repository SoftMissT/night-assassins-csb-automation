...
export const FLAME_FORMS = Object.freeze([
  { id: "chamas_01", style: 3, name: "San no Kata Hitoappu", ptName: "Esquentar", passive: true, action: null, weaponHeat: 0, enemyHeat: 0, levels: [LEVEL(0), LEVEL(0), LEVEL(0), LEVEL(0)] },
  { id: "chamas_02", style: 1, name: "Ichi no Kata Shiranui", ptName: "Fogo Desconhecido / Tempestade Ígnea", action: "especial", weaponHeat: 2, enemyHeat: 0, damageTypes: ["fogo"], levels: [
  ...
  { id: "chamas_03", style: 2, name: "Ni no Kata Nobori en Ten", ptName: "Céu em Chamas Ascendentes", action: "ataque", weaponHeat: 3, enemyHeat: 2, levels: [
  ...
  { id: "chamas_04", style: 4, name: "Shi no Kata Sei en no Uneri", ptName: "Ondulação da Chama Fluorescente", action: "reacao", weaponHeat: 2, enemyHeat: 0, levels: [
    LEVEL(1, { blockBonus: 1 }), LEVEL(1, { blockBonus: 2 }), LEVEL(2, { blockBonus: 3 }), LEVEL(3, { blockBonus: 4 }),
  ] },
  { id: "chamas_05", style: 5, name: "Go no Kata Enko", ptName: "Tigre Ardente", action: "ataque", weaponHeat: 3, enemyHeat: 3, damageTypes: ["fogo"], levels: [
  ...
  { id: "chamas_06", style: 6, name: "Roku no Kata Hono Arashi", ptName: "Tormenta de Chamas", action: "ataque", weaponHeat: 4, enemyHeat: 4, damageTypes: ["fogo"], levels: [
  ...
  { id: "chamas_07", style: 7, name: "Shichi no Kata Yaki Suru", ptName: "Cauterizar", action: "especial", weaponHeat: 0, enemyHeat: 0, minimumWeaponHeat: 5, levels: [
    LEVEL(2, { healing: "1d6" }), LEVEL(3, { healing: "2d6" }), LEVEL(3, { healing: "3d6", removeBleeding: true }), LEVEL(4, { healing: "4d6", removeBleeding: true }),
  ] },
  { id: "chamas_08", style: 8, name: "Hachi no Kata Tenka", ptName: "Ignição", action: "especial", weaponHeat: 0, enemyHeat: 0, levels: [
    null, null, LEVEL(5, { selfDamage: 5, damageBonus: 5, turns: 3 }), LEVEL(5, { selfDamage: 5, damageBonus: 8, turns: 3 }),
  ] },
  { id: "chamas_09", style: 9, name: "Ku no Kata Rengoku", ptName: "Rengoku", action: "ataque", weaponHeat: 4, enemyHeat: 4, damageTypes: ["fogo"], levels: [
