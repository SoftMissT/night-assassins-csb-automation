...
- `img` é a única imagem do Item e deve apontar para o ícone da arma em `assets/icons/weapons/`; o campo legado `arma_imagem_vertical` não faz parte do contrato do template.
