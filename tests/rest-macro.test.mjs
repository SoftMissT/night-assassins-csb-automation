...
const macroSource = fs.readFileSync(path.join(repoRoot, "macros", "na-gerenciar-descanso.js"), "utf8");
const AsyncFunction = Object.getPrototypeOf(async function () {}).constructor;

test("macro de Descanso usa o Actor da ficha e não devolve objeto ao CSB", async () => {
  let received = null;
  const game = { modules: new Map([["night-assassins-csb-automation", { api: { openRestManager: async (args) => { received = args; } } }]]) };
